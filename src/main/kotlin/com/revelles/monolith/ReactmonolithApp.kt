...
import com.revelles.monolith.config.ApplicationProperties
...
class ReactmonolithApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes reactmonolith.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ReactmonolithApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ReactmonolithApp::class.java)
