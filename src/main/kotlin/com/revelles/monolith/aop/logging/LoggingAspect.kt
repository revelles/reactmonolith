package com.revelles.monolith.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.revelles.monolith.repository..*)" +
            " || within(com.revelles.monolith.service..*)" +
            " || within(com.revelles.monolith.web.rest..*)"
    )
