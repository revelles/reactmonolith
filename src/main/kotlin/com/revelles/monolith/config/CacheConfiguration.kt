package com.revelles.monolith.config
...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.revelles.monolith.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.revelles.monolith.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.revelles.monolith.domain.User::class.java.name)
            createCache(cm, com.revelles.monolith.domain.Authority::class.java.name)
            createCache(cm, com.revelles.monolith.domain.User::class.java.name + ".authorities")
            createCache(cm, com.revelles.monolith.domain.Author::class.java.name)
            createCache(cm, com.revelles.monolith.domain.Author::class.java.name + ".books")
            createCache(cm, com.revelles.monolith.domain.Book::class.java.name)
